...
public class LeetCodeSolution {
    ...
    public static boolean findPartitions(int startIndex, int sum, String stringNum, int target, int[][] memo) {
        ...
        for (int currentIndex = startIndex; currentIndex < stringNum.length(); currentIndex++) {
            ...
            partitionFound = partitionFound || findPartitions(currentIndex + 1,
                    sum + addend, stringNum, target, memo);
